  ...
  return (
    <div className="w-50 h-100 d-flex align-items-center justify-content-center">
      ...
      >
         ...
         <svg width="37" height="105" viewBox="0 0 37 105" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M36 6V47.1111V90.9293C36 92.6385 35.127 94.2292 33.6852 95.1471L21.1852 103.105C19.547 104.148 17.453 104.148 15.8148 103.105L3.31481 95.1471C1.87303 94.2292 1 92.6385 1 90.9293V70.6667V47.1111V23.5556V6C1 3.23858 3.23858 1 6 1H18.5H31C33.7614 1 36 3.23858 36 6Z" fill="#FAA4BD" stroke="url(#paint0_linear_373_45)" strokeWidth="2"/> <defs> <linearGradient id="paint0_linear_373_45" x1="18.5" y1="0" x2="18.5" y2="106" gradientUnits="userSpaceOnUse"> <stop stopColor="#FAA4BD"/> <stop offset="0.255208" stopColor="#533B42" stopOpacity="0"/> <stop offset="0.723958" stopColor="#533B4D" stopOpacity="0.3"/> </linearGradient> </defs> </svg>
         </div>
