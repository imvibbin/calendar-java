    ...
    <div className="container-fluid text-center text-light">
        <div className="row vh-100">
            <div style={{backgroundColor: "pink"}} className="col-2 ">
                <div style={{backgroundColor: "pink"}} className="col-12 p-3 d-flex flex-row justify-content-between align-items-around sidebar-card">
                ...
                <ul>
                    ...
                    <li className={"schedule"}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M22 12C22 17.52 17.52 22 12 22C6.48 22 2 17.52 2 12C2 6.48 6.48 2 12 2C17.52 2 22 6.48 22 12Z" stroke="#0177FB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M15.71 15.18L12.61 13.33C12.07 13.01 11.63 12.24 11.63 11.61V7.50999" stroke="#0177FB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        <span>Schedule</span>
                    </li>
                </ul>
