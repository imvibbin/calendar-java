...
const Landing = () => {
    ...
    <div className="container-fluid text-center text-light">
        <div className="row vh-100">
            ...
            <div style={{backgroundColor: "lightcoral"}} className="col-7 border border-white">
                <div>
                    ...
                    <div className={"d-flex justify-content-between"}>
                        <div className={""}>
                            <span className={"nobreak"}> 02 - 08 March</span>
                        ...
                        <div> (GMT 6:00) Public Time</div>
                    </div>
                </div>
            </div>
            <div style={{backgroundColor: "blue"}} className="col-3 border border-white ">
                -
            </div>
