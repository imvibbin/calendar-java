...
const RegisterPage = () => {
  ...
  return (
    <>
      <div className="main-container d-flex align-items-end justify-content-end p-5 vh-100">
        <div className="main-container-content d-flex flex-column align-items-center justify-content-between">
          <div className="calendar-top w-100 position-relative">
          ...
          <div className="main-container-form w-100 px-5 py-5 d-flex justify-content-between align-items-center">
            <form
